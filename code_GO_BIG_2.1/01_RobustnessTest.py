...
#
# 01_RobustnessTest
#    Rapidly switches back and forth between two 480x480 images
#    Ran for 20 hours - still working!
#    Visible time to switch between images - about 3-4 seconds
#
...
TIME_TILL_NEXT_BG = 10             # time in seconds till load next background
