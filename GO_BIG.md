...
* [The Plan](#the-plan "The Plan")
  * [Hardware for GO BIG and GO BIGGER](#hardware-for-go-big-and-go-bigger "Hardware for GO BIG and GO BIGGER")
    ...
    * [Entrance for USB Cable in Plastic Globe](#entrance-for-usb-cable-in-plastic-globe "Entrance for USB Cable in Plastic Globe")
...
- Ha Ha Ha! ... and a mirthless chuckle! That was incorrect. The two displays use a different controller chip with different initialization etc.
